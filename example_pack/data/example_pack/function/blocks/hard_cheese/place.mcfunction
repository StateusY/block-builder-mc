...
execute unless block ~ ~ ~ #minecraft:air run return run loot spawn ~ ~ ~ loot example_pack:blocks/hard_cheese
execute align xyz positioned ~0.5 ~0.5 ~0.5 as @n[tag=smithed.block,distance=..0.1] at @s run return run loot spawn ~ ~ ~ loot example_pack:blocks/hard_cheese
...
# run data to macro
function example_pack:blocks/hard_cheese/macro with storage example_pack:temp
scoreboard players set @n[type=minecraft:item_display,tag=example_pack.hard_cheese] example_pack.hard_cheese.hit_count 0
scoreboard players set @n[type=minecraft:item_display,tag=example_pack.hard_cheese] example_pack.hard_cheese.hit_timer 0